      ...
      <section className="relative py-20 bg-primary-navy text-white text-center overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-4">
          ...
          <p className="text-gray-300 text-sm sm:text-base max-w-2xl mx-auto font-light">
            How emergency medical services are coordinated from the national level down to communities in Gombe State.
          </p>
        </div>
      </section>
                ...
                <div className="w-full max-w-xl">
                  <button
                    ...
                    className={`w-full text-left p-5 rounded-2xl border transition-all duration-300 flex items-center justify-between ${
                      activeNode === node.id
                        ? "bg-primary-navy text-white border-transparent shadow-lg"
                        : "bg-bg-gray border-gray-150 text-primary-navy hover:bg-white hover:shadow-md"
                    }`}
                  >
                  ...
                  <AnimatePresence>
                    {activeNode === node.id && (
                      ...
                      >
                        <div className="bg-primary-navy/5 border-x border-b border-primary-navy/10 rounded-b-2xl p-5 -mt-2 text-xs sm:text-sm text-muted-text leading-relaxed font-light flex gap-3">
      ...
      <section className="py-24 bg-bg-gray">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* National Level */}
            <div className="bg-white rounded-3xl p-8 border border-gray-150 hover:shadow-lg transition-all group">
              <div className="w-12 h-12 rounded-2xl bg-primary-navy/5 text-primary-navy flex items-center justify-center mb-6 group-hover:scale-105 transition-transform">
            ...
            {/* State Coordination */}
            <div className="bg-white rounded-3xl p-8 border border-gray-150 hover:shadow-lg transition-all group">
              <div className="w-12 h-12 rounded-2xl bg-emergency-blue/5 text-emergency-blue flex items-center justify-center mb-6 group-hover:scale-105 transition-transform">
            ...
            {/* Field Operations */}
            <div className="bg-white rounded-3xl p-8 border border-gray-150 hover:shadow-lg transition-all group">
              <div className="w-12 h-12 rounded-2xl bg-emergency-red/5 text-emergency-red flex items-center justify-center mb-6 group-hover:scale-105 transition-transform">
